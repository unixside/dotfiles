...
(let ((base    "#faf4ed")
    ...
    (custom-theme-set-faces
     ...
     `(org-level-8 ((t (:weight normal :foreground ,love))))
     `(org-level-7 ((t (:weight normal :foreground ,iris))))
     `(org-level-6 ((t (:weight normal :foreground ,rose))))
     `(org-level-5 ((t (:weight normal :foreground ,gold))))
     `(org-level-4 ((t (:weight normal :foreground ,foam))))
     `(org-level-3 ((t (:weight normal :foreground ,pine))))
     `(org-level-2 ((t (:weight normal :foreground ,love))))
     `(org-level-1 ((t (:weight normal :foreground ,iris))))
